			...
			<div class="card-body">
				<div class="easyui-layout">
					<table id="dgGrid" title="<?= $title; ?>"
						...
						rowNumbers="true"
						pagination="true"
						url="<?= base_url('admin/getwh_Params') ?>"
						pageSize="20"
			...
			<form id="ff" class="easyui-form" method="post" data-options="novalidate:false" enctype="multipart/form-data">
				...
				<div style="margin-bottom:20px">
					<input class="easyui-combobox" name="param_group" style="width:100%"
						data-options="label:'Parameter Group:',required:true,valueField:'param_group',textField:'param_group',url:'<?= base_url('admin/getGroupwh_Params') ?>'">
				</div>
				<div style="margin-bottom:20px">
