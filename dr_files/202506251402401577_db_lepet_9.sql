...
--
-- Host: localhost:3306
-- Waktu pembuatan: 24 Jun 2025 pada 12.03
-- Versi server: 8.4.3
-- Versi PHP: 7.4.33
...
CREATE TABLE `accounting_bank` (
  ...
  `account_bank` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `accounting_daily_report` (
  ...
  `know1` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `know2` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `accounting_daily_report_balance` (
  `id` int NOT NULL,
  `id_dr` int NOT NULL,
  `id_bank` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `accounting_daily_report_transaction` (
  `id` int NOT NULL,
  `id_dr` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `transaction_desc` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `in-out` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `id_bank` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `accounting_voucher` (
  `id` int NOT NULL,
  `no_doc` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `account` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `incharge` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `date` date NOT NULL,
  `recipient` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `recipient_bank` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `dr_file` (
  ...
  `id_table` int NOT NULL,
  `is_aktiv` int NOT NULL DEFAULT '0'
...
CREATE TABLE `file_shared` (
  `id` int NOT NULL,
  `level1` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `params` (
  ...
  `param_group` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `sd_ho_lv1` (
  ...
  `depart` varchar(255) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_penjualan` (
  ...
  `id_penagih` int NOT NULL,
  `status_bayar` enum('0','1','2') NOT NULL,
  `status_penjualan` int NOT NULL,
  `tgl_tempo` int NOT NULL,
  `total` int NOT NULL,
...
CREATE TABLE `tbl_po` (
  ...
  `po_description` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `tbl_supplier` (
  ...
  `rek_bank` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `wh_distribution` (
  ...
  `employee_id_from` int DEFAULT NULL,
  `employee_id_to` int DEFAULT NULL,
  `qty` int NOT NULL,
  `distribution_date` date NOT NULL,
  `distribution_type` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `remark` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `from_suplier_id` int DEFAULT NULL,
  `to_suplier_id` int DEFAULT NULL,
...
CREATE TABLE `wh_items` (
  ...
  `inisial_kuantitas` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `Level_1` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `level_2` varchar(255) COLLATE utf8mb4_general_ci DEFAULT '-',
  `level_3` varchar(255) COLLATE utf8mb4_general_ci DEFAULT '-',
  `level_4` varchar(255) COLLATE utf8mb4_general_ci DEFAULT '-',
  `remark` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '-',
  `is_deleted` int NOT NULL DEFAULT '0',
  `path_foto` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `wh_item_set` (
  ...
  `doc` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `wh_warehouse` (
  `id` int NOT NULL,
  `wh_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
