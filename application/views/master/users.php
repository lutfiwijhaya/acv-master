...
<div class="col-12">
    <div class="card">
            ...
            <div class="card-body">
                <div class="easyui-layout">
                    <table id="dgGrid" title=""
                        ...
                        <thead>
                            <tr>
                                <th field="is_approval" width="8%" align="center" formatter="formatApprovalCheckbox">Approval</th>
                    ...
                    <div id="toolbar" style="padding: 10px">
                        <div class="row ml-1">
                            <div class="col-sm-6">
                                ...
                                <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-users" plain="false" onclick="hakakses()">Access Authority</a>
        ...
        <!-- Dialog Form (sama seperti sebelumnya) -->
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // Event delegation untuk checkbox approval
        $(document).on('change', '.approval-checkbox', function() {
            ...
            $.ajax({
                url: '<?= base_url('user/toggleApproval') ?>',
                type: 'POST',
                data: {
                    id: userId,
                    status: isChecked
                ...
                error: function() {
                    ...
                    // Kembalikan status checkbox jika error
                    checkbox.prop('checked', !isChecked);
                },
                complete: function() {
    ...
    // Formatter untuk checkbox approval
    function formatApprovalCheckbox(value, row, index) {
        var checked = value == 1 ? 'checked' : '';
        return '<input type="checkbox" class="approval-checkbox" data-userid="' + row._id + '" ' + checked + '>';
    }
    ...
    function hakakses() {
        ...
        if (row) {
            window.location.replace("akses_user/" + row._id);
        }
    }
