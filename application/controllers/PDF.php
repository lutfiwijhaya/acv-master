...
class PDF extends CI_Controller {
    ...
    public function generate_rpa($rpa_id) {
        ...
        // Get detail RPA dengan join ke COA dan COA Category
        $data['rpa_details'] = $this->Rpa_model->get_rpa_details_for_print_enhanced($rpa_id);

        // Get supplier info
        $data['supplier'] = $this->Rpa_model->get_supplier_for_print($data['rpa']->supplier_id);

        // Get Drafter Info (User who created the RPA)
        // Data sudah ada di print_rpa_by_id dengan nama created_by_name dan created_by_signature
        $data['drafter_name'] = $data['rpa']->created_by_name ?? 'Unknown';
        $data['drafter_signature'] = $data['rpa']->created_by_signature ?? null;
        $data['drafter_position'] = $data['rpa']->created_by_position ?? null;
        $data['drafter_email'] = $data['rpa']->created_by_email ?? null;
        ...
        // Set chroot ke FCPATH atau array paths
        $options->set('chroot', [
            FCPATH,
            APPPATH,
            FCPATH . 'assets/',
    ...
    public function download_rpa($rpa_id) {
        ...
        // Get detail with category
        $data['rpa_details'] = $this->Rpa_model->get_rpa_details_for_print_enhanced($rpa_id);
        $data['supplier'] = $this->Rpa_model->get_supplier_for_print($data['rpa']->supplier_id);

        // Get Drafter Info from print_rpa_by_id result
        $data['drafter_name'] = $data['rpa']->created_by_name ?? 'Unknown';
        $data['drafter_signature'] = $data['rpa']->created_by_signature ?? null;
        $data['drafter_position'] = $data['rpa']->created_by_position ?? null;
        $data['drafter_email'] = $data['rpa']->created_by_email ?? null;
